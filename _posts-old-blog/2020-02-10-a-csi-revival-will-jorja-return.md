...
In somewhat surprising news, CBS is looking at a revival of <em>CSI</em>!
...
This is of course all we know for now, but currently only Marg Helgenberger is actively working on a project on CBS (she's on<em> All Rise</em> as a lesbian judge). Absolutely no deals are signed at the moment, and it may all fall apart, so don't assume this is a go.
